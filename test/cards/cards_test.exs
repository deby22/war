defmodule Cards.CardsTest do
  ...
  test "Create a spades cards" do
    # spades - black
    assert %Card{suit: "spade", value: "1", power: 1, color: "black"} ==
             Deck.create_card("spade", "1")
  ...
  test "Create a clubes cards" do
    # clubes - black
    assert %Card{suit: "club", value: "1", power: 1, color: "black"} ==
             Deck.create_card("club", "1")
  ...
  test "Create a hearts cards" do
    # hearts - red
    assert %Card{suit: "heart", value: "1", power: 1, color: "red"} ==
             Deck.create_card("heart", "1")
  ...
  test "Create a diamonds cards" do
    # diamonds - red
    assert %Card{suit: "diamond", value: "1", power: 1, color: "red"} ==
             Deck.create_card("diamond", "1")
  ...
  test "created deck of card should have 26 red and 26 black cards" do
    assert 26 ==
  ...
  test "create and merge few deck of card" do
    deck = Deck.create_deck(10)
    assert 520 == Enum.count(deck)
  end
end
